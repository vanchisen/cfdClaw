...
OUTPNG = BASE / 'most_unstable_phase_vs_x_Re5K_Re11K.png'
OUTCSV = BASE / 'most_unstable_phase_vs_x_Re5K_Re11K.csv'
...
def main():
    ...
    plt.plot(df5['x'], df5['omega_imag'], 'o-', lw=1.8, ms=4, label='Re5K')
    plt.plot(df11['x'], df11['omega_imag'], 's-', lw=1.8, ms=4, label='Re11K')
    plt.xlabel('x')
    plt.ylabel(r'Most unstable phase')
    plt.title('Most unstable temporal phase vs x')
